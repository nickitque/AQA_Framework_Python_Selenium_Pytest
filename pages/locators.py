...
class BasePageLocators:
    ...
    WHATSAPP_BTN_HEADER = (By.CSS_SELECTOR,
                           "#wrapper-navbar > div.header1.header > div > div > ul > li:nth-child(1) > a")
    MESSENGER_BTN_HEADER = (By.CSS_SELECTOR,
                            "#wrapper-navbar > div.header1.header > div > div > ul > li:nth-child(2) > a")
    ...
    ADDRESS_TEXT_FOOTER = (By.CSS_SELECTOR,
                           "#page > footer > div > div.footer-row.row2 > ul.footer_about_address > li:nth-child(1) > a")
    ADDRESS_ICON_FOOTER = (By.CSS_SELECTOR, "#page > footer > div > div.footer-row.row2 >"
                                            " ul.footer_about_address > li:nth-child(1) > a > img")
    SCHEDULE_ICON_FOOTER = (By.CSS_SELECTOR, "#page > footer > div > div.footer-row.row2 >"
                                             " ul.footer_about_address > li:nth-child(2) > img")
    SCHEDULE_TEXT_FOOTER = (By.CSS_SELECTOR,
                            "#page > footer > div > div.footer-row.row2 > ul.footer_about_address > li:nth-child(2)")
    # question about prev locator
    PHONE_NUMBER_FOOTER = (By.CSS_SELECTOR,
                           "#page > footer > div > div.footer-row.row2 > ul.footer_about_address > li:nth-child(3) > a")
    PHONE_NUMBER_ICON_FOOTER = (By.CSS_SELECTOR, "#page > footer > div > div.footer-row.row2 >"
